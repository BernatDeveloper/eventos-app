...
export const FeaturesSection = () => {
  ...
  return (
    <section className="py-20 px-6 max-w-6xl mx-auto">
      <h2 className="text-4xl font-semibold text-center mb-12" data-aos="fade-up">{t('features.title')}</h2>
...
export const FeatureCard = ({ icon, title, description }: FeatureCardProps) => (
  <div className="flex flex-col items-center space-y-4 p-6 border border-[var(--background-secondary-color)] rounded-[var(--border-radius-medium)] shadow-[var(--box-shadow-light)]" data-aos="fade-up">
