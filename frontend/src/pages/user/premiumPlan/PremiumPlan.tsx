...
export const PremiumPlan = () => {
  ...
  return (
    <section
      className="max-w-md mx-auto p-6 bg-[var(--background-secondary-color)] rounded-lg shadow-md"
    >
      <h2
        className="text-3xl font-bold mb-6 text-[var(--primary-color)]"
      >
      ...
      {premiumStatus?.is_premium ? (
        ...
        <>
          ...
          {retryCountdown && (
            <p
              className="mt-4 text-yellow-600 font-medium text-center"
