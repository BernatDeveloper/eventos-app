    ...
    return (
        <div className="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-2xl shadow-lg">
            {event ? (
                <>
                    ...
                    {event.location && (
                        <div className="mb-6">
                            ...
                            <p className="text-gray-700 text-sm">Lat: {event.location.latitude}, Lng: {event.location.longitude}</p>
                ...
                <p className="text-center text-gray-500">No se encontró el evento.</p>
            )}
        </div>
    );
};
